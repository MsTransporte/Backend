...
urlpatterns = [
    ...
    path('VerifDemande', views.VerifDemande.as_view()),
    path('VerifPaiment', views.VerifPaiment.as_view()),
    path('EffecteTache', views.EffecteTache.as_view()),
    path('TermineTache', views.TermineTache.as_view()),
    #  path('AcceptIntervention', views.AcceptIntervention.as_view()),
    path('InsertTaches', views.InsertTaches.as_view()),
    ...
    path('AffichePaimentAll', views.AffichePaimentAll.as_view()),
    path('AfficheMeuble', views.AfficheMeuble.as_view()),
    path('AfficheProduit', views.AfficheProduit.as_view()),
    path('AfficheListMeuble',views.AfficheListMeuble.as_view()),
